...
var u = (function () {
    function t(t, e, r) {
      if ((void 0 === e && (e = {}), void 0 === r && (r = {}), !t || 'string' != typeof t))
  ...
  a = (function () {
    ...
    return (
      ...
      (n.denormalizeValue = function (t, e) {
        var n = i(t) ? t.get('schema') : t.schema;
        return this.isSingleSchema || n
          ? e(
              (this.isSingleSchema ? void 0 : i(t) ? t.get('id') : t.id) || t,
  ...
  f = (function (t) {
    ...
    var i = e.prototype;
    return (
      (i.normalize = function (t, e, r, i, o, u) {
        var a = this;
        return Object.keys(t).reduce(function (e, r, c) {
          var f,
            s = t[r];
          return null != s ? n({}, e, (((f = {})[r] = a.normalizeValue(s, t, r, i, o, u)), f)) : e;
        }, {});
      }),
      (i.denormalize = function (t, e) {
        var r = this;
        return Object.keys(t).reduce(function (i, o) {
          var u,
            a = t[o];
          return n({}, i, (((u = {})[o] = r.denormalizeValue(a, e)), u));
        }, {});
      }),
      e
    );
  ...
  l = function (t, e, n, r, i, o, u) {
    return (
      (t = s(t)),
      h(e).map(function (e, a) {
    ...
    return (
      Object.keys(t).forEach(function (n) {
        var r = t[n],
          ...
          f = o(e[n], e, n, i, u, a);
        void 0 === f ? delete c[n] : (c[n] = f);
      }),
      c
    );
  },
  d = function (t, e, r) {
    if (i(e)) return o(t, e, r);
    var u = n({}, e);
    return (
      Object.keys(t).forEach(function (e) {
        null != u[e] && (u[e] = r(u[e], t[e]));
      }),
      u
    );
  },
  v = function t(e, n, r, i, o, u) {
    return 'object' == typeof e && e
      ? 'object' != typeof i || (i.normalize && 'function' == typeof i.normalize)
        ? i.normalize(e, n, r, t, o, u)
        : (Array.isArray(i) ? l : p)(i, e, n, r, t, o, u)
      : e;
  },
  g = {
    Array: m,
  ...
  b = function (t) {
    ...
    return function t(o, a) {
      return 'object' != typeof a || (a.denormalize && 'function' == typeof a.denormalize)
        ? null == o
          ? o
          : a instanceof u
          ? (function (t, e, r, o, a) {
              var c = o(t, e);
              if ((void 0 === c && e instanceof u && (c = e.fallback(t, e)), 'object' != typeof c || null === c))
                return c;
              if ((a[e.key] || (a[e.key] = {}), !a[e.key][t])) {
                var f = i(c) ? c : n({}, c);
                (a[e.key][t] = f), (a[e.key][t] = e.denormalize(f, r));
              }
              return a[e.key][t];
            })(o, a, t, r, e)
          : a.denormalize(o, t)
        : (Array.isArray(a) ? y : d)(a, o, t);
    };
  },
  k = function (t) {
    var e = i(t);
...
(exports.denormalize = function (t, e, n) {
  if (void 0 !== t) return b(n)(t, e);
}),
  (exports.normalize = function (t, e) {
    ...
    return { entities: n, result: v(t, t, null, e, r, {}) };
  }),
  (exports.schema = g);
